				...
				<?php
					...
					?>		
						<div class="col-md-3 mt-3">
							<div class="card">
								<img src="img/<?php echo $data['image']; ?>" height='400px' alt="img">
								<div class="card-body bg-dark">
									...
									<button class="btn btn-info" type="button" ><a href="addbookuser.php?U_ID=<?php echo $data['id'] ?>"> BOOK </a></button>
								</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-3 mt-3">
							<div class="card">
								...
								<div class="card-body bg-dark">
									...
									<p class="card-text">
									<button class="btn btn-info" type="button" ><a href="book.php?U_ID=<?php echo $data2['id'] ?>"> Book Now </a></button>
									</p>
								</div>
							</div>
						</div>
